...
import torch
from .preprocess import preprocess_adj, preprocess, construct_interaction, add_contrastive_label, get_feature, permutation, fix_seed, get_gene_graph_cluster
import time
import random
import numpy as np
...
class STING():
    def __init__(self, 
        ...
        adata1 = adata.copy()
        sc.pp.highly_variable_genes(adata1, flavor="seurat_v3", n_top_genes=dim_input)
